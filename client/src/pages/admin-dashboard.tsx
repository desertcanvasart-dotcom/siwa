    ...
    },
    {
      ...
      sections: [
        ...
        },
        {
          ...
          description: 'The white "Soléi difference" section — header plus the three cards.',
          fields: [
            ...
            { key: 'home.moments.cards.0.n', label: 'Card 1 — numeral', placeholder: 'I.' },
            { key: 'home.moments.cards.0.title', label: 'Card 1 — title', placeholder: 'The salt lakes at sunset' },
            { key: 'home.moments.cards.0.body', label: 'Card 1 — text', multiline: true },
            { key: 'home.moments.cards.0.cta', label: 'Card 1 — link text', placeholder: 'Experience this →' },
            { key: 'home.moments.cards.0.href', label: 'Card 1 — link URL', placeholder: '/siwa-oasis/experiences/salt-and-spring-escape' },
            { key: 'home.moments.cards.1.n', label: 'Card 2 — numeral', placeholder: 'II.' },
            { key: 'home.moments.cards.1.title', label: 'Card 2 — title', placeholder: 'An evening without a schedule' },
            { key: 'home.moments.cards.1.body', label: 'Card 2 — text', multiline: true },
            { key: 'home.moments.cards.1.cta', label: 'Card 2 — link text', placeholder: 'Experience this →' },
            { key: 'home.moments.cards.1.href', label: 'Card 2 — link URL', placeholder: '/siwa-oasis/experiences/desert-night-experience' },
            { key: 'home.moments.cards.2.n', label: 'Card 3 — numeral', placeholder: 'III.' },
            { key: 'home.moments.cards.2.title', label: 'Card 3 — title', placeholder: 'The stillness of the oasis' },
            { key: 'home.moments.cards.2.body', label: 'Card 3 — text', multiline: true },
            { key: 'home.moments.cards.2.cta', label: 'Card 3 — link text', placeholder: 'Experience this →' },
            { key: 'home.moments.cards.2.href', label: 'Card 3 — link URL', placeholder: '/siwa-oasis/experiences/siwa-essential-experience' },
          ],
        },
        {
          id: 'philosophy',
          label: 'What we believe (Philosophy)',
          description: 'Centered pull-quote below the Moments cards. The quote reads: "[quote] [accent word] [ending]" — the accent word is shown in blue.',
          fields: [
            { key: 'home.philosophy.eyebrow', label: 'Eyebrow', placeholder: 'What we believe' },
            { key: 'home.philosophy.quote', label: 'Quote (before accent)', multiline: true, placeholder: "We don\'t show you Egypt. We create the conditions for you to" },
            { key: 'home.philosophy.accent', label: 'Accent word', placeholder: 'feel' },
            { key: 'home.philosophy.quote_end', label: 'Quote ending', placeholder: 'it.' },
            { key: 'home.philosophy.body', label: 'Body', multiline: true },
            { key: 'home.philosophy.cta', label: 'Link text', placeholder: 'Our story' },
            { key: 'home.philosophy.cta_href', label: 'Link URL', placeholder: '/our-story' },
          ],
        },
        {
          id: 'transport',
          label: 'Transportation',
          description: 'Navy "Arrive the right way" section with the route list. Grey text is what the site shows now — type to replace it. To hide a route, enter - as its name. Route 6 is unused — fill it in to add a route.',
          fields: [
            { key: 'home.transport.eyebrow', label: 'Eyebrow', placeholder: 'Arrive the right way' },
            { key: 'home.transport.title', label: 'Title (before italic)', placeholder: 'Private' },
            { key: 'home.transport.italic', label: 'Italic accent', placeholder: 'transportation' },
            { key: 'home.transport.title_2', label: 'Title (second line)', placeholder: 'that earns its place.' },
            { key: 'home.transport.body', label: 'Body', multiline: true },
            { key: 'home.transport.cta', label: 'Button label', placeholder: 'View all routes' },
            { key: 'home.transport.cta_href', label: 'Button URL', placeholder: '/siwa-oasis/transportation' },
            { key: 'home.transport.media', label: 'Background image or video', type: 'media', placeholder: '/videos/salt-lake.mp4' },
            { key: 'home.transport.routes.0.name', label: 'Route 1 — name', placeholder: 'Cairo → Siwa Oasis' },
            { key: 'home.transport.routes.0.detail', label: 'Route 1 — detail line', placeholder: '~8 hours · Private vehicle · Desert road' },
            { key: 'home.transport.routes.0.tag', label: 'Route 1 — right-hand tag', placeholder: 'Private →' },
            { key: 'home.transport.routes.0.href', label: 'Route 1 — URL', placeholder: '/siwa-oasis/transportation' },
            { key: 'home.transport.routes.1.name', label: 'Route 2 — name', placeholder: 'Marsa Matrouh → Siwa' },
            { key: 'home.transport.routes.1.detail', label: 'Route 2 — detail line', placeholder: '~3 hours · Private 4×4 · Sand road' },
            { key: 'home.transport.routes.1.tag', label: 'Route 2 — right-hand tag', placeholder: 'Private →' },
            { key: 'home.transport.routes.1.href', label: 'Route 2 — URL', placeholder: '/siwa-oasis/transportation' },
            { key: 'home.transport.routes.2.name', label: 'Route 3 — name', placeholder: 'Cairo → North Coast' },
            { key: 'home.transport.routes.2.detail', label: 'Route 3 — detail line', placeholder: '~2.5 hours · Private vehicle' },
            { key: 'home.transport.routes.2.tag', label: 'Route 3 — right-hand tag', placeholder: 'Private →' },
            { key: 'home.transport.routes.2.href', label: 'Route 3 — URL', placeholder: '/north-coast/transportation' },
            { key: 'home.transport.routes.3.name', label: 'Route 4 — name', placeholder: 'Alexandria → North Coast' },
            { key: 'home.transport.routes.3.detail', label: 'Route 4 — detail line', placeholder: '~1 hour · Private vehicle' },
            { key: 'home.transport.routes.3.tag', label: 'Route 4 — right-hand tag', placeholder: 'Private →' },
            { key: 'home.transport.routes.3.href', label: 'Route 4 — URL', placeholder: '/north-coast/transportation' },
            { key: 'home.transport.routes.4.name', label: 'Route 5 — name', placeholder: 'In-oasis desert drives' },
            { key: 'home.transport.routes.4.detail', label: 'Route 5 — detail line', placeholder: 'Siwa · 4×4 · Dunes, salt flats, spring pools' },
            { key: 'home.transport.routes.4.tag', label: 'Route 5 — right-hand tag', placeholder: 'Experience →' },
            { key: 'home.transport.routes.4.href', label: 'Route 5 — URL', placeholder: '/siwa-oasis/transportation' },
            { key: 'home.transport.routes.5.name', label: 'Route 6 — name', placeholder: '(empty — add a route)' },
            { key: 'home.transport.routes.5.detail', label: 'Route 6 — detail line', placeholder: '~2 hours · Private vehicle' },
            { key: 'home.transport.routes.5.tag', label: 'Route 6 — right-hand tag', placeholder: 'Private →' },
            { key: 'home.transport.routes.5.href', label: 'Route 6 — URL', placeholder: '/north-coast/transportation' },
          ],
        },
        {
          id: 'journal',
          label: 'Journal',
          description: '"Stories from the field" — three article cards linking to the journal.',
          fields: [
            { key: 'home.journal.eyebrow', label: 'Eyebrow', placeholder: 'The Soléi Journal' },
            { key: 'home.journal.title', label: 'Title (before italic)', placeholder: 'Stories from' },
            { key: 'home.journal.italic', label: 'Italic accent', placeholder: 'the field' },
            { key: 'home.journal.all_label', label: '"Read all" link label', placeholder: 'Read all →' },
            { key: 'home.journal.all_href', label: '"Read all" link URL', placeholder: '/journal' },
            { key: 'home.journal.articles.0.href', label: 'Lead (large) card — article URL', placeholder: '/journal/healing-waters-of-siwa-salt-lake-therapy' },
            { key: 'home.journal.articles.0.tag', label: 'Lead (large) card — label', placeholder: 'Siwa Oasis' },
            { key: 'home.journal.articles.0.title', label: 'Lead (large) card — title', multiline: true, placeholder: 'Why Siwa\'s salt lakes feel like the end of the world…' },
            { key: 'home.journal.articles.0.excerpt', label: 'Lead (large) card — excerpt', multiline: true },
            { key: 'home.journal.articles.0.meta', label: 'Lead (large) card — read time', placeholder: '8 min read · Experiences' },
            { key: 'home.journal.articles.0.image', label: 'Lead (large) card — image', type: 'media-image' },
            { key: 'home.journal.articles.1.href', label: 'Card 2 — article URL', placeholder: '/journal/ultimate-guide-to-egypts-north-coast' },
            { key: 'home.journal.articles.1.tag', label: 'Card 2 — label', placeholder: 'North Coast' },
            { key: 'home.journal.articles.1.title', label: 'Card 2 — title', multiline: true, placeholder: 'The quiet side of Egypt\'s North Coast…' },
            { key: 'home.journal.articles.1.meta', label: 'Card 2 — read time', placeholder: '5 min read' },
            { key: 'home.journal.articles.1.image', label: 'Card 2 — image', type: 'media-image' },
            { key: 'home.journal.articles.2.href', label: 'Card 3 — article URL', placeholder: '/journal/stargazing-in-siwa-guide-to-desert-night-sky' },
            { key: 'home.journal.articles.2.tag', label: 'Card 3 — label', placeholder: 'Siwa · Experiences' },
            { key: 'home.journal.articles.2.title', label: 'Card 3 — title', multiline: true, placeholder: 'What an unscheduled evening in the desert…' },
            { key: 'home.journal.articles.2.meta', label: 'Card 3 — read time', placeholder: '6 min read' },
            { key: 'home.journal.articles.2.image', label: 'Card 3 — image', type: 'media-image' },
          ],
        },
        {
          id: 'closing',
          ...
          fields: [
            ...
            { key: 'home.closing.primary_href', label: 'Primary button — URL', placeholder: '/enquire' },
            { key: 'home.closing.secondary_cta', label: 'Secondary button', placeholder: 'Our story' },
            { key: 'home.closing.secondary_href', label: 'Secondary button — URL', placeholder: '/our-story' },
          ],
        },
      ],
    },
